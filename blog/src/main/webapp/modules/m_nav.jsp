...
<a style="text-align: left" href = "${pageContext.request.contextPath}/post">/post</a>
<a style="text-align: left" href = "${pageContext.request.contextPath}/post/edit">/edit</a>
 | 
<a style="text-align: left" href = "${pageContext.request.contextPath}/blog">/blog</a>
<a style="text-align: left" href = "${pageContext.request.contextPath}/blog/edit">/edit</a>
 | 
<a style="text-align: left" href = "${pageContext.request.contextPath}/profile">/profile</a>
